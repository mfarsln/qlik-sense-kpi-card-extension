...
define(['qlik', './constants', './themes', './formatters'], function (qlik, constantsModule, themesModule, formatters) {
		...
		type: 'items', component: 'accordion', items: {
			...
			appearance: { uses: 'settings', items: {
				...
				contentSection: { type: 'items', label: 'Content', items: {
					...
					kpiScope: { ref: 'props.kpiScope', label: 'KPI Scope', type: 'string', component: 'dropdown', expression: 'optional', options: [ { value: 'full', label: 'Full data' }, { value: 'window', label: 'Trend window' }, { value: 'selection', label: 'Selection Range (from current date selection)' }, { value: 'today', label: 'Today (last data point)' }, { value: 'wtd', label: 'Week to Date (WTD)' }, { value: 'mtd', label: 'Month to Date (MTD)' }, { value: 'qtd', label: 'Quarter to Date (QTD)' }, { value: 'ytd', label: 'Year to Date (YTD)' }, { value: 'last7d', label: 'Last 7 Days' }, { value: 'last30d', label: 'Last 30 Days' }, { value: 'last90d', label: 'Last 90 Days' } ], defaultValue: 'full' },
				...
				// Scope Quick Buttons (Today / MTD / YTD style toggles that drive kpiScope at runtime)
				scopeButtonsSection: { type: 'items', label: 'KPI Scope Quick Buttons', items: {
					showScopeButtons: { ref: 'props.showScopeButtons', label: 'Show Scope Quick Buttons', type: 'boolean', defaultValue: false },
					scopeButtonsDisplay: { ref: 'props.scopeButtonsDisplay', label: 'Display Style', type: 'string', component: 'dropdown', options: [ { value: 'chip', label: 'Compact Chip + Dropdown (Recommended)' }, { value: 'buttons', label: 'Expanded Buttons (3 visible)' } ], defaultValue: 'chip', show: function(d){ return d && d.props && d.props.showScopeButtons; } },
					linkTrendToScope: { ref: 'props.linkTrendToScope', label: 'Link Trend Window to Scope (auto-zoom + hide trend buttons)', type: 'boolean', defaultValue: false, show: function(d){ return d && d.props && d.props.showScopeButtons; } },
					autoSwitchToSelection: { ref: 'props.autoSwitchToSelection', label: 'Auto-switch to Selection Range when date is selected', type: 'boolean', defaultValue: true, show: function(d){ return d && d.props && d.props.showScopeButtons; } },
					scopeButton1Value: { ref: 'props.scopeButton1Value', label: 'Button 1 Scope', type: 'string', component: 'dropdown', options: [ { value: 'today', label: 'Today' }, { value: 'wtd', label: 'Week to Date' }, { value: 'mtd', label: 'Month to Date' }, { value: 'qtd', label: 'Quarter to Date' }, { value: 'ytd', label: 'Year to Date' }, { value: 'last7d', label: 'Last 7 Days' }, { value: 'last30d', label: 'Last 30 Days' }, { value: 'last90d', label: 'Last 90 Days' } ], defaultValue: 'today', show: function(d){ return d && d.props && d.props.showScopeButtons; } },
					scopeButton1Label: { ref: 'props.scopeButton1Label', label: 'Button 1 Label', type: 'string', defaultValue: 'Today', show: function(d){ return d && d.props && d.props.showScopeButtons; } },
					scopeButton2Value: { ref: 'props.scopeButton2Value', label: 'Button 2 Scope', type: 'string', component: 'dropdown', options: [ { value: 'today', label: 'Today' }, { value: 'wtd', label: 'Week to Date' }, { value: 'mtd', label: 'Month to Date' }, { value: 'qtd', label: 'Quarter to Date' }, { value: 'ytd', label: 'Year to Date' }, { value: 'last7d', label: 'Last 7 Days' }, { value: 'last30d', label: 'Last 30 Days' }, { value: 'last90d', label: 'Last 90 Days' } ], defaultValue: 'mtd', show: function(d){ return d && d.props && d.props.showScopeButtons; } },
					scopeButton2Label: { ref: 'props.scopeButton2Label', label: 'Button 2 Label', type: 'string', defaultValue: 'MTD', show: function(d){ return d && d.props && d.props.showScopeButtons; } },
					scopeButton3Value: { ref: 'props.scopeButton3Value', label: 'Button 3 Scope', type: 'string', component: 'dropdown', options: [ { value: 'today', label: 'Today' }, { value: 'wtd', label: 'Week to Date' }, { value: 'mtd', label: 'Month to Date' }, { value: 'qtd', label: 'Quarter to Date' }, { value: 'ytd', label: 'Year to Date' }, { value: 'last7d', label: 'Last 7 Days' }, { value: 'last30d', label: 'Last 30 Days' }, { value: 'last90d', label: 'Last 90 Days' } ], defaultValue: 'ytd', show: function(d){ return d && d.props && d.props.showScopeButtons; } },
					scopeButton3Label: { ref: 'props.scopeButton3Label', label: 'Button 3 Label', type: 'string', defaultValue: 'YTD', show: function(d){ return d && d.props && d.props.showScopeButtons; } },
					defaultScopeButton: { ref: 'props.defaultScopeButton', label: 'Default Selected Button', type: 'string', component: 'dropdown', options: [ { value: 'button1', label: 'Button 1' }, { value: 'button2', label: 'Button 2' }, { value: 'button3', label: 'Button 3' } ], defaultValue: 'button2', show: function(d){ return d && d.props && d.props.showScopeButtons; } },
					currentSelectedScopeButton: { ref: 'props.currentSelectedScopeButton', label: 'Current Selected Scope Button (Internal)', type: 'string', defaultValue: '', show: function(){ return false; } },
					scopeButtonStyle: { ref: 'props.scopeButtonStyle', label: 'Button Style', type: 'string', component: 'dropdown', options: [ { value: 'minimal', label: 'Minimal' }, { value: 'rounded', label: 'Rounded' }, { value: 'pill', label: 'Pill' } ], defaultValue: 'rounded', show: function(d){ return d && d.props && d.props.showScopeButtons; } },
					scopeButtonBackgroundColor: { ref: 'props.scopeButtonBackgroundColor', label: 'Inactive Button Background Color', type: 'string', defaultValue: 'rgba(255,255,255,0.1)', show: function(d){ return d && d.props && d.props.showScopeButtons; } },
					scopeButtonLabelColor: { ref: 'props.scopeButtonLabelColor', label: 'Inactive Button Label Color', type: 'string', defaultValue: '', show: function(d){ return d && d.props && d.props.showScopeButtons; } },
					scopeButtonActiveColor: { ref: 'props.scopeButtonActiveColor', label: 'Active Button Background Color', type: 'string', defaultValue: '#3b82f6', show: function(d){ return d && d.props && d.props.showScopeButtons; } },
					scopeButtonActiveLabelColor: { ref: 'props.scopeButtonActiveLabelColor', label: 'Active Button Label Color', type: 'string', defaultValue: '#ffffff', show: function(d){ return d && d.props && d.props.showScopeButtons; } },
					showScopeHighlight: { ref: 'props.showScopeHighlight', label: 'Show Period Start Marker on Trend', type: 'boolean', defaultValue: true, show: function(d){ return d && d.props && d.props.showScopeButtons; } },
					scopeHighlightCurrentColor: { ref: 'props.scopeHighlightCurrentColor', label: 'Period Marker Color', type: 'string', defaultValue: '#3b82f6', show: function(d){ return d && d.props && d.props.showScopeButtons && d.props.showScopeHighlight !== false; } },
					scopeHighlightPreviousColor: { ref: 'props.scopeHighlightPreviousColor', label: 'Previous Period Highlight Color (unused)', type: 'string', defaultValue: '#f59e0b', show: function(){ return false; } },
					scopeHighlightOpacity: { ref: 'props.scopeHighlightOpacity', label: 'Marker Opacity Hint (0-1)', type: 'number', defaultValue: 0.18, show: function(d){ return d && d.props && d.props.showScopeButtons && d.props.showScopeHighlight !== false; } }
				} },
				...
				secondaryKpiSection: { type: 'items', label: 'Secondary KPI', items: {
					secondarySource: { ref: 'props.secondarySource', label: 'Source', type: 'string', component: 'dropdown', options: [ { value: 'measure2', label: '2nd Measure (from Data > Measures)' }, { value: 'previousPeriod', label: 'Previous Period Value (auto)' } ], defaultValue: 'measure2' },
					...
					secondaryLabel: { ref: 'props.secondaryLabel', label: 'Custom Label (leave empty for default)', type: 'string', expression: 'optional', defaultValue: '' },
				...
				colorsSection: { type: 'items', label: 'Colors & Theme', items: {
					...
					backgroundOpacity: { ref: 'props.backgroundOpacity', label: 'Background Opacity', type: 'number', component: 'slider', min: 0, max: 1, step: 0.05, defaultValue: 1, show: function(d) { return d && d.props && d.props.theme === 'custom'; } },
				...
				iconSection: { type: 'items', label: 'Icons', items: {
					...
					iconCustom: { ref: 'props.iconCustom', label: 'Custom Icon Markup', type: 'string', component: 'textarea', rows: 8, maxlength: 200000, defaultValue: '', show: function(d) { return d && d.props && d.props.showIcon && d.props.iconPack === 'custom'; } },
				...
				interactionSection: { type: 'items', label: 'Interaction / Actions', items: {
					...
					selectedIndicator: { ref: 'props.selectedIndicator', label: 'Selected Indicator Style', type: 'string', component: 'dropdown', options: [ { value: 'tapered-bar', label: 'Neon Bar (Modern)' }, { value: 'side-accent', label: 'Side Accent (Left Bar)' }, { value: 'border', label: 'Full Border' }, { value: 'bottom-border', label: 'Bottom Border' }, { value: 'top-border', label: 'Top Border' }, { value: 'glow', label: 'Glow Effect' }, { value: 'background', label: 'Background Tint' } ], defaultValue: 'tapered-bar', show: function(d) { return d && d.props && d.props.enableClick; } },
				...
				deltaSection: { type: 'items', label: 'Delta & Status', items: {
					...
					deltaMode: { ref: 'props.deltaMode', label: 'Delta Mode', type: 'string', component: 'dropdown', options: [ { value: 'matchScope', label: 'Match KPI Scope (Auto - Recommended)' }, { value: 'points', label: 'Previous N points (manual offset)' }, { value: 'calendar', label: 'Previous Calendar Period (day/week/month/quarter/year)' } ], defaultValue: 'matchScope', show: function(layout) { return layout.props.showDelta; } },
					deltaCalendarUnit: { ref: 'props.deltaCalendarUnit', label: 'Compare to Previous', type: 'string', component: 'dropdown', options: [ { value: 'day', label: 'Day' }, { value: 'week', label: 'Week (7 days)' }, { value: 'month', label: 'Month' }, { value: 'quarter', label: 'Quarter (3 months)' }, { value: 'year', label: 'Year' } ], defaultValue: 'month', show: function(layout) { return layout.props.showDelta && layout.props.deltaMode === 'calendar'; } },
					deltaPoints: { ref: 'props.deltaPoints', label: 'Window Size N (points)', type: 'number', expression: 'optional', defaultValue: 1, show: function(layout) { return layout.props.showDelta && (layout.props.deltaMode || 'points') === 'points'; } },
					deltaOffset: { ref: 'props.deltaOffset', label: 'Compare Offset (in windows)', type: 'number', expression: 'optional', defaultValue: 1, show: function(layout) { return layout.props.showDelta && (layout.props.deltaMode || 'points') === 'points'; } },
					deltaAgg: { ref: 'props.deltaAgg', label: 'Delta Aggregation', type: 'string', component: 'dropdown', expression: 'optional', options: [ { value: 'last', label: 'Last' }, { value: 'sum', label: 'Sum' }, { value: 'avg', label: 'Average' } ], defaultValue: 'last', show: function(layout) { return layout.props.showDelta && (layout.props.deltaMode || 'points') === 'points'; } },
					...
					comparisonHintMode: { ref: 'props.comparisonHintMode', label: 'Compared Date Ranges Hint', type: 'string', component: 'dropdown', options: [ { value: 'off', label: 'Off (no hints)' }, { value: 'chips', label: 'Chips only (Recommended)' }, { value: 'subtitle', label: 'Chips + Subtitle under Secondary KPI' }, { value: 'tooltip', label: 'Chips + Tooltip on Delta hover' }, { value: 'both', label: 'Chips + Subtitle + Tooltip' }, { value: 'hover', label: 'Hover Only (modern tooltip on Secondary KPI)' }, { value: 'all', label: 'All (Chips + Subtitle + Tooltip + Hover)' } ], defaultValue: 'chips', show: function(d) { return d && d.props && d.props.showDelta; } }
				} },
				// Trend Section
				...
				forecastSection: { type: 'items', label: 'Forecast', items: {
					...
					forecastPeriods: { ref: 'props.forecastPeriods', label: 'Forecast Periods (steps ahead)', type: 'number', defaultValue: 5, min: 1, max: 60, show: function(d) { return d && d.props && d.props.showForecast; } },
					forecastTrainingWindow: { ref: 'props.forecastTrainingWindow', label: 'Training Data (history used to fit model)', type: 'string', component: 'dropdown', options: [ { value: 'currentWindow', label: 'Current Trend Window (visible data)' }, { value: 'last30d', label: 'Last 30 Days' }, { value: 'last90d', label: 'Last 90 Days (Recommended)' }, { value: 'last180d', label: 'Last 180 Days' }, { value: 'last365d', label: 'Last 365 Days' }, { value: 'last12p', label: 'Last 12 Points' }, { value: 'last30p', label: 'Last 30 Points' }, { value: 'last60p', label: 'Last 60 Points' }, { value: 'last120p', label: 'Last 120 Points' }, { value: 'all', label: 'All Data' } ], defaultValue: 'last90d', show: function(d) { return d && d.props && d.props.showForecast; } },
					forecastMethod: {
	...
	// ── Initial Properties ───────────────────────────────────────────────────
	var initialProperties = { qHyperCubeDef: { qDimensions: [], qMeasures: [], qInterColumnSortOrder: [], qNoOfLeftDims: 1, qSuppressMissing: true, qInitialDataFetch: [{ qTop: 0, qLeft: 0, qWidth: 3, qHeight: 1000 }] }, props: { showLabelDates: true, align: 'left', fontMode: 'static', valueFontSize: 28, valueFontFamily: 'Open Sans', titleFontSize: 12, titleFontFamily: 'Open Sans', deltaFontSize: 16, deltaFontFamily: 'Open Sans', labelFontSize: 10, labelFontFamily: 'Open Sans', measureLabelSize: 11, measureLabelFontFamily: 'Open Sans', measureLabelPos: 'bottom', measureLabelGap: 4, theme: 'custom', valueColor: '#111111', titleColor: '#111111', labelColor: '#555555', measureLabelColor: '#666666', backgroundColor: 'transparent', backgroundOpacity: 1, borderColor: 'transparent', borderWidth: 0, borderRadius: 0, padding: 8, cardElevation: 'none', useGradient: false, gradientPreset: 'custom', gradientStart: '#3b82f6', gradientEnd: '#8b5cf6', gradientDirection: 'vertical', showIcon: false, iconPack: 'emoji', iconType: 'chart', iconSize: 24, iconCustom: '', iconPosition: 'top-right', showStatusBadge: false, enableClick: false, clickAction: 'select-field-value', selectFieldName: '', selectFieldValue: '', variableName: '', variableValue: '', selectedIndicator: 'bottom-border', selectedColor: '#3b82f6', kpiSectionHeight: 60, trendSectionHeight: 40, sectionGap: 1, showDelta: true, deltaDisplayType: 'percentage', deltaUseShortFormat: false, deltaMode: 'matchScope', deltaCalendarUnit: 'month', deltaPoints: 1, deltaOffset: 1, deltaAgg: 'last', comparisonHintMode: 'chips', deltaDecimals: 1, deltaUpColor: '#16a34a', deltaDownColor: '#dc2626', deltaNeutralColor: '#9ca3af', deltaGap: 6, showTrend: true, trendPosition: 'bottom', trendHeight: 0, trendTopMarginPx: 0, pulseRadius: 1.8, pulseMinColor: '#dc2626', pulseMaxColor: '#16a34a', showGlow: false, glowColor: '#ffffff', glowStdDev: 2, animateDraw: true, animDurationMs: 600, animatePulse: true, pulseAnimDelay: 300, animateArea: false, areaAnimDuration: 800, animateValue: true, valueAnimDuration: 1000, animateDelta: false, deltaAnimDuration: 600, trendMode: 'line', trendCorners: 'sharp', lineColor: '#3f51b5', lineWidth: 1.5, areaColor: '#3f51b5', areaOpacity: 0.2, labelMaxWidthPct: 45, endLabelOffsetPx: 8, startLabelRightPadPx: 6, kpiAgg: 'last', kpiScope: 'full', secondaryKpiPosition: 'below', secondarySource: 'measure2', secondaryLabel: '', secondaryColor: '#94a3b8', secondaryFontSize: 16, secondaryFontFamily: 'Open Sans', trendWindowMode: 'lastNPoints', trendWindowPoints: 60, trendWindowDays: 180, showTooltip: true, showMinMax: true, labelsGapPx: 2, areaGradient: false, areaGradientType: 'vertical', areaGradStartColor: '#3f51b5', areaGradEndColor: '#3f51b5', areaGradStartOpacity: 0.2, areaGradEndOpacity: 0, showQuickButtons: true, button1Value: 12, button1Label: '12P', button2Value: 60, button2Label: '60P', button3Value: 365, button3Label: '1Y', buttonStyle: 'rounded', buttonBackgroundColor: 'rgba(255,255,255,0.1)', buttonLabelColor: '', buttonActiveColor: '#3b82f6', buttonActiveLabelColor: '#ffffff', defaultButton: 'button2', currentSelectedButton: 'button2', hoverValueScale: true, hoverLineThickness: true, hoverLineThicknessMultiplier: 1.5, darkMode: false, enableBackgroundCondition: false, backgroundConditionOperator: 'gt', backgroundConditionValue: 0, backgroundConditionValue2: 0, backgroundConditionColor: '#1f2937', progressMaxValue: 100, progressBarWidthPct: 100, forecastTrainingWindow: 'last90d', showScopeButtons: false, scopeButtonsDisplay: 'chip', linkTrendToScope: false, autoSwitchToSelection: true, scopeButton1Value: 'today', scopeButton1Label: 'Today', scopeButton2Value: 'mtd', scopeButton2Label: 'MTD', scopeButton3Value: 'ytd', scopeButton3Label: 'YTD', defaultScopeButton: 'button2', currentSelectedScopeButton: '', scopeButtonStyle: 'rounded', scopeButtonBackgroundColor: 'rgba(255,255,255,0.1)', scopeButtonLabelColor: '', scopeButtonActiveColor: '#3b82f6', scopeButtonActiveLabelColor: '#ffffff', showScopeHighlight: true, scopeHighlightCurrentColor: '#3b82f6', scopeHighlightPreviousColor: '#f59e0b', scopeHighlightOpacity: 0.18, configPresetAction: '', configPresetText: '' } };
